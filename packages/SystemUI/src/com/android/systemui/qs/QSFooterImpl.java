...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    private void setBuildText() {
        ...
        boolean isShow = Settings.System.getIntForUser(mContext.getContentResolver(),
                        Settings.System.VALIDUS_FOOTER_TEXT_SHOW, 0,
                        UserHandle.USER_CURRENT) == 1;
        String text = Settings.System.getStringForUser(mContext.getContentResolver(),
                        Settings.System.VALIDUS_FOOTER_TEXT_STRING,
    ...
    protected void onAttachedToWindow() {
        ...
        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.VALIDUS_FOOTER_TEXT_SHOW), false,
                mSettingsObserver, UserHandle.USER_ALL);

        mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor(Settings.System.VALIDUS_FOOTER_TEXT_STRING), false,
                mSettingsObserver, UserHandle.USER_ALL);
    }
